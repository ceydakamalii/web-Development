...
*/
var arac=[
    {id:'bmw116d_1234',model : '116d',yil : 2015, renk : 'white' ,servisKayitlari : [
        {
            id : 'bmw116d_123_1',
            tarih : '20.01.2016',
            km : '13000',
...
console.log(arac[0]);
console.log(arac[0].id);
console.log(arac[0].model);
console.log(arac[0].renk);
console.log(arac[0].servisKayitlari);
console.log(arac[0].servisKayitlari[0]);

console.log(arac[0].servisKayitlari[0].km);
console.log(arac[0].servisKayitlari[0].ucret);
console.log(arac[0].servisKayitlari[0].detay[0].ucret);