...
function init(settings){
    //setTimeout bir süre sonra başlatılcak bir fonksiyonu belirtiyoruz.
    //setInterval clearInterval ile durdurmadığımız sürece devam eden iş setTimeout ile farkı budur.
    //clearInterval
    var prev;
